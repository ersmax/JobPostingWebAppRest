...
const Edit = () => {
  ...
  useEffect(() => {
    const fetchInitialPosts = async (id) => {  
      const response = await axios.get(`/jobPost/${id}`);
  ...
  const handleChange = (e) => {
    ...
    setForm({ 
      ...
      postTechStack: checked
        ...
        : form.postTechStack.filter((s) => s !== value),
    });
  };
  ...
  const allSkills = [
    ...new Set([...skillSet.map((s) => s.name), ...form.postTechStack]),
  ];
      ...
      <form autoComplete="off" noValidate onSubmit={handleSubmit}>
        ...
        >
          <TextField
            ...
            label="Post ID (assigned automatically)"
            variant="outlined"
            value={form.postId}
            disabled
          />
